...
class AgedPartnerBalanceCustomHandlerTus(models.AbstractModel):
    _inherit = 'account.aged.partner.balance.report.handler'

    def _prepare_partner_values(self):
        res = super()._prepare_partner_values()
        res.update({'po_number_ref_reference': None})
        return res
    ...
    def _aged_partner_report_custom_engine_common(self, options, internal_type, current_groupby, next_groupby, offset=0,
        ...
        def build_result_dict(report, query_res_lines):
            ...
            if current_groupby == 'id':
                ...
                rslt.update({
                    'po_number_ref_reference': query_res['po_number_ref_reference'][0] if len(
                        query_res['po_number_ref_reference']) == 1 else None,
        ...
        query = f"""
            ...
            SELECT
                ...
                ARRAY_AGG(DISTINCT move.po_number) AS po_number_ref_reference,
